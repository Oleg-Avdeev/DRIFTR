...
{
    [ExecuteInEditMode]
    public class TurretMesh : MonoBehaviour
    {
        ...
        public void GenerateMesh()
        {
            ...
            veritces.Add(new Vector3(0, 0.3f, 0)); normals.Add(veritces[0]);
            ...
            veritces.Add(new Vector3(0, -0.25f, 0)); normals.Add(veritces[5]);
